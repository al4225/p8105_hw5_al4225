...
```
    ...
    ##        <int> <int>    <dbl>    <dbl> <chr>            
    ##  1         0     1  -0.745  0.449    fail to reject H0
    ##  2         0     2   0.219  0.809    fail to reject H0
    ##  3         0     3  -0.320  0.665    fail to reject H0
    ##  4         0     4   2.54   0.000594 reject H0        
    ##  5         0     5  -0.715  0.517    fail to reject H0
    ##  6         0     6   1.36   0.114    fail to reject H0
    ##  7         0     7  -0.602  0.517    fail to reject H0
    ##  8         0     8   0.929  0.448    fail to reject H0
    ##  9         0     9  -0.0849 0.922    fail to reject H0
    ## 10         0    10  -0.683  0.428    fail to reject H0
