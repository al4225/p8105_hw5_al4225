...
```
    ...
    ##        <int> <int>    <dbl>   <dbl> <chr>            
    ##  1         0     1  -0.324    0.766 fail to reject H0
    ##  2         0     2   0.126    0.907 fail to reject H0
    ##  3         0     3  -0.359    0.686 fail to reject H0
    ##  4         0     4   0.0465   0.962 fail to reject H0
    ##  5         0     5   0.651    0.486 fail to reject H0
    ##  6         0     6   0.252    0.815 fail to reject H0
    ##  7         0     7   0.411    0.666 fail to reject H0
    ##  8         0     8  -0.630    0.489 fail to reject H0
    ##  9         0     9  -0.828    0.381 fail to reject H0
    ## 10         0    10   0.372    0.700 fail to reject H0
