...
```
    ...
    ##        <int> <int>    <dbl>   <dbl> <chr>            
    ##  1         0     1   -1.50   0.157  fail to reject H0
    ##  2         0     2   -0.750  0.399  fail to reject H0
    ##  3         0     3    0.221  0.829  fail to reject H0
    ##  4         0     4   -0.875  0.347  fail to reject H0
    ##  5         0     5    0.388  0.657  fail to reject H0
    ##  6         0     6   -0.291  0.722  fail to reject H0
    ##  7         0     7   -2.04   0.0108 reject H0        
    ##  8         0     8   -1.14   0.238  fail to reject H0
    ##  9         0     9   -0.981  0.307  fail to reject H0
    ## 10         0    10   -0.900  0.325  fail to reject H0
...
```
    ...
    ## 1         0   0.01126087             0.1528733
    ## 2         1   0.97585923             2.2389316
    ## 3         2   1.99288951             2.6283120
    ## 4         3   2.99360015             3.1933883
    ## 5         4   3.97136025             4.0023333
    ## 6         5   5.00766576             5.0096192
    ## 7         6   5.97788570             5.9778857
